...
@section('tittle',"Tambah Data Isu Hardware")
@section('conten')

<div class="row">
    <div class="col-md-12">

        <form action="{{route('isuhard.simpan')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Tambah Data Isu Hardware<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{$errors->has('hardware') ? ' has-error' : ''}}">
                                ...
                                @if ($errors->has('hardware'))
                                    <span class="help-block">{{$errors->first('hardware')}}</span>
                                @endif
                            </div>
                            ...
                            <div class="form-group {{$errors->has('nama_hardware') ? ' has-error' : ''}}">
                                <label>Nama Hardware</label>
                                <input type="text" class="form-control" name="nama_hardware">
                                @if ($errors->has('nama_hardware'))
                                <span class="help-block">{{$errors->first('nama_hardware')}}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{$errors->has('nomor_tiket') ? ' has-error' : ''}}">
                                <label>Nomor Tiket</label>
                                    <input type="text" class="form-control" name="nomor_tiket">
                                @if ($errors->has('nomor_tiket'))
                                <span class="help-block">{{$errors->first('nomor_tiket')}}</span>
                                @endif
                            </div>
                    ...
                    <div class="text-right">
                        <a href="{{route('data.isuhard')}}" class="btn btn-danger btn-sm"><i class=" icon-cross3"></i>Batal</a> 
