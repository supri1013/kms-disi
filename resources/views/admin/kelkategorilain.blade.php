...
@section('tittle',"Data Kategori Lain")
@section('conten')

<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">DATA KATEGORI PERMASALAHAN</h5>
                       ...
                       <div class="modal-dialog">
                           <div class="modal-content">
                               <div class="modal-header">
                                   ...
                                   <h5 class="modal-title">Edit Data Kategori Permasalahan</h5>
                               </div>
                   
                               <form action="kategorilain/{{$kategori->id}}/update" method="POST" class="form-controller">
                                   @csrf
...
<div id="modal-tambah-forumdiskusi" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h5 class="modal-title">Tambah Data Kategori Permasalahan</h5>
            </div>

            <form action="{{route('kategorilain.simpan')}}" method="POST" class="form-controller">
               @csrf
               <div class="modal-body">
...
<script>
   $('.delete').click(function(){
       ...
       swal({
               ...
               if (willDelete) {
                  window.location = "/kategorilain/"+isu_id+"/delete";
