...
@section('tittle',"View Dokumen")
@section('conten')

   
    <div class="row">
        <div class="col-md-7">
        <iframe src="{{url('/assets/data/dokumen/'. $data->file)}}" frameborder="1" style="width: 100%; height: 950px;"></iframe>
        </div>
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">ISBN/DOI/ISSN:</label>
                        <div class="col-lg-9">
