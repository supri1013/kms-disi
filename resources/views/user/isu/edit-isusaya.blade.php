...
@section('tittle',"Edit Isu")
@section('conten')

<div class="row">
    <div class="col-md-12">

        <form action="/isu/saya/update/{{$data_newisu->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Edit Isu<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{$errors->has('namaob_rusak') ? ' has-error' : ''}}">
                                <label>Objek Isu</label>
                                    <input type="text" class="form-control" name="namaob_rusak" value="{{$data_newisu->namaob_rusak}}">
                            ...
                            <div class="form-group {{$errors->has('bagianob_rusak') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="bagianob_rusak" value="{{$data_newisu->bagianob_rusak}}">
                            ...
                            <div class="form-group {{$errors->has('tanggal') ? ' has-error' : ''}}">
                                <label>Tanggal Kejadian</label>
                                    <input type="date" class="form-control" name="tanggal" value="{{$data_newisu->tanggal}}">
                            ...
                            <div class="form-group {{$errors->has('jam_mulai') ? ' has-error' : ''}}">
                                <label>Jam Mulai</label>
                                    <input type="time" class="form-control" name="jam_mulai" value="{{$data_newisu->jam_mulai}}">
                            ...
                            <div class="form-group {{$errors->has('jam_selesai') ? ' has-error' : ''}}">
                                ...
                                <input type="time" class="form-control" name="jam_selesai" value="{{$data_newisu->jam_selesai}}">
                            ...
                            <div class="form-group {{$errors->has('lama') ? ' has-error' : ''}}">
                                ...
                                <input type="time" class="form-control" name="lama" value="{{$data_newisu->lama}}">
                                @if ($errors->has('lama'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group {{$errors->has('pelapor') ? ' has-error' : ''}}">
                                <label>Pelapor</label>
                                <input type="text" class="form-control" name="pelapor" value="{{$data_newisu->pelapor}}">
                            ...
                            <div class="form-group form-group {{$errors->has('nama_permasalahan') ? ' has-error' : ''}}">
                                <label>Kendala</label>
                                <input type="text" class="form-control" name="nama_permasalahan" value="{{$data_newisu->nama_permasalahan}}">
                            ...
                            <div class="form-group {{$errors->has('penyelesaian') ? ' has-error' : ''}}">
                                <label>Solusi</label>
                                    <input type="text" class="form-control" name="penyelesaian" value="{{$data_newisu->penyelesaian}}">
                            ...
                            <div class="form-group {{$errors->has('detail_permasalahan') ? ' has-error' : ''}}">
                                <label>Detail Permasalahan</label>
                                    <input type="text" class="form-control" name="detail_permasalahan" value="{{$data_newisu->detail_permasalahan}}">
                            ...
                            <div class="form-group {{$errors->has('kode') ? ' has-error' : ''}}">
                                <label>Kode</label>
                                <input type="text" class="form-control" name="kode" value="{{$data_newisu->kode}}">
                                @if ($errors->has('kode'))
                            ...
                            <div class="form-group {{$errors->has('no_tiket') ? ' has-error' : ''}}">
                                <label>Nomor Tiket</label>
                                    <input type="text" class="form-control" name="no_tiket" value="{{$data_newisu->no_tiket}}">
                    ...
                    <div class="text-right">
                        <a href="{{route('isu.saya')}}" class="btn btn-danger btn-sm"><i class=" icon-cross3"></i>Batal</a> 
