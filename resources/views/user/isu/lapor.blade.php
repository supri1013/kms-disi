...
@section('tittle',"Tambah Isu")
@section('conten')

<form action="{{route('save.isu')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="user_id" value="{{auth()->user()->id}}">
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Tambah Isu<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
